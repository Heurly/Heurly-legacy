...
export default function ToolsLink() {
    ...
    return (
        <div className={cn("border-t border-neutral-600 bg-gray-200 text-neutral-950 flex flex-col place-content-end gap-y-3 py-3 px-7 w-full h-30","dark:bg-neutral-950 dark:text-white")}>
