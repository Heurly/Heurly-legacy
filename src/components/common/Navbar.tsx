...
const NavBar: React.FunctionComponent = () => {
  ...
  const links = [
    ...
    return (
      ...
      <label htmlFor="navbarToggle" className={cn("z-40 fixed top-2 left-2 cursor-pointer w-8 h-8 p-1 hover:bg-neutral-600 rounded-lg text-neutral-950","dark:text-white")}>
        ...
        {links.map((link, index) => (
            <Link key={index} href={link.urlLink} as={link.urlLink}>
              ...
              <div className="flex gap-x-3 p-1 rounded-lg hover:bg-neutral-600 transition duration-200 cursor-pointer">
                <div className={cn("flex items-center text-neutral-950","dark:text-white")}>
