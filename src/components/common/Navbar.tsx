...
const NavBar: React.FunctionComponent = () => {
  ...
  return (
    <nav className="flex flex-col items-center space-y-10 py-10 top-0 h-screen transition-transform -translate-x-full sm:translate-x-0 dark: bg-neutral-950 border-r border-neutral-600 text-white">
