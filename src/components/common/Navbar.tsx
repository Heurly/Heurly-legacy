...
const NavBar: React.FunctionComponent = () => {
    ...
    return (
        <nav
            className="flex md:flex-col items-center justify-between md:h-full md:w-1/5 w-full m-0 bg-neutral-950 border-r border-neutral-600 text-white fixed top-0 gap-y-5 max-w-sm min-w-[250px] overflow-auto">
