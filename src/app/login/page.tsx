  ...
  return (
    <SessionProvider>
      <div className="md:flex w-full h-screen">
        <div className="md:w-1/2 h-1/2 md:h-full flex justify-center items-center">
          <div className="flex flex-col gap-y-4">
            <h1 className="text-4xl text-neutral-400 font-black text-center md:text-left">
              Bienvenue sur <span className={cn("text-neutral-950","dark:text-white")}>ESIEE&nbsp;HUB</span>
            </h1>
        ...
        <div className={cn("md:w-1/2 h-1/2 md:h-full bg-white border-l-2 border-gray-600 flex justify-center items-center",
        "dark:bg-black")}>
